<template>
    <div>
              <!-- 订单的详情 -->
        <div class="orderAll  " v-for="(item,index) in goodsorder"  :key="item+index"  v-show="datalist.length">
        ...
        <div class="nodegood" v-show="!datalist.length">
...
<script>
    export default {
        ...
        created(){
          ...
          this.datalist=this.goodsorder.filter(item=>item.type==0)
        },
         beforeUpdate(){
